...
function pagination(currentPage, allPages = (0, _index.totalPage)) {
    ...
    if (currentPage > 3) markup += `<li class='number-pagination'><button> ${beforeTwoPage}</button></li>`;
    if (currentPage > 2) markup += `<li class='number-pagination'><button>${beforePage}</button></li>`;
    ...
    if (allPages - 1 > currentPage) {
        if (afterPage <= allPages) markup += `<li class='number-pagination'><button>${afterPage}</button></li>`;
    }
    if (allPages - 2 > currentPage) {
        if (afterTwoPage <= allPages) markup += `<li class='number-pagination'><button>${afterTwoPage}</button></li>`;
    }
...
function handlrePagination(evt) {
    ...
    if (evt.target.textContent === "left") {
        (0, _fetchLordDefault.default)(globalCurrentPage -= 1).then((data)=>{
            ...
            (0, _notiflixDefault.default).Notify.failure("Data error");
        });
        return;
    }
...
},{"./fetchLord":"5h9r2","../index":"8lqZg","../images/symbol-defs.svg":"8r0xV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5z0Oc"}],"5h9r2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
